...
plt.savefig('bernoulli_pf_parametre_1/ospa_results.png', dpi=1100, bbox_inches='tight')
plt.show()
...
plt.xlabel('x[m]')
plt.ylabel('y[m]')
plt.savefig('bernoulli_pf_parametre_1/detections.png',dpi=1100, bbox_inches='tight')
plt.show()
...
plt.ylabel(r'$q_{k|k}$')
plt.xlabel('Discrete time - k')
plt.savefig('bernoulli_pf_parametre_1/bernoulli_particle_filter_qkk.png', dpi=1100, bbox_inches='tight')
plt.show()

with open('bernoulli_pf_parametre_1/bernoulli_pf_parametre_1_simulation_records.json', 'w') as json_file:
